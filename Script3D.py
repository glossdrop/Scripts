...
from cellpose import plot, transforms,utils, models
import skimage

dir="C:/Users/cavalieri/Desktop/CFOS/JULIEN/DAPI/TEST3D"
os.chdir(dir)
...
seglist=glob.glob("*.npy")
dat = np.load(seglist[0], allow_pickle=True).item()
...
print("Elaspsed time: " + str((end - start)/60) + " mins")